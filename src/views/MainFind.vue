  ...
  <div >
    ...
    <div class="dayTuijian"> 
      <header style='width:100%;display:flex;justify-content: space-between;margin-top:10px;'>
         ...
         <router-link to='/top/playlist/highquality' style='padding:5px;border-radius:10px;font-size:12px; border:1px solid #eee; color:gray;'>歌单广场</router-link>
      </header>
     
      <div v-for='(item, index) in dayTui' :key='index' style='width:31%;margin-top:15px;' v-if='index < 6' >
    ...
    <div class="dayTuijian"> 
      <header style='width:100%;display:flex;justify-content: space-between;margin-top:10px;'>
         ...
         <router-link to='/top/playlist/highquality' style='padding:5px;border-radius:10px;font-size:12px; border:1px solid #eee; color:gray;'>更多新碟</router-link>
      </header>
     
      <div v-for='(item, index) in newDie' :key='index' style='width:31%;margin-top:10px;' v-if='index < 3' >
        
        <router-link :to="{path: '/xianxi', params : {id : item.id }}"  style='position:relative;'>
           <img :src="item.picUrl" alt=""  style="width:100%;">
